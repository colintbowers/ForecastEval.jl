...
Acknowledgement: I compared the output from MCSBoot with that generated by Kevin Sheppard's MATLAB code for the
Model Confidence Set (and get the same numbers). Many thanks to Kevin Sheppard for making that code available to the public.
"""
